<template>
  <div class="container">
    ...
    <div class="book-detail-container">
      <div
        class="book-detail"
        v-for="(data, index) in bookList.filter(bookList => bookList.status === 'finnished')"
        :key="index"
      >
    ...
    <div class="book-detail-container">
      <div class="book-detail" v-for="(data, index) in bookList.filter(bookList => bookList.status !== 'finnished')" :key="index">
        <div class="book-description">
          <h1 class="book-title">{{ data.bookTitle }}</h1>
          <h1 class="book-author">{{ data.bookAuthor }}</h1>
        </div>
